...
export const cashDeposits = pgTable("cash_deposits", {
  ...
  slipValidationStatus: text("slip_validation_status"),
  slipValidationReason: text("slip_validation_reason"),
...
export const cashManagementSettings = pgTable("cash_management_settings", {
  ...
  referenceDepositSlip: text("reference_deposit_slip"),
  depositTolerance: decimal("deposit_tolerance", { precision: 10, scale: 2 }).default("1.00"),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow(),
});
